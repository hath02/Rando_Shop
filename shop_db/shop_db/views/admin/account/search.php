            ...
            <tr>
                ...
                <td>
                    <div class="admin-action">
                        <a href="/shop_db/index.php?action=admin_edit_account&id=<?= $row['id']; ?>" class="admin-btn">
                            Edit
                        </a>

                        <a href="/shop_db/index.php?action=admin_delete_account&id=<?= $row['id']; ?>" class="btn btn-danger">
                            Delete
                        </a>
                    </div>
                </td>
